...
test('parse custom lib', () => {
  ...
  expect(parsed).toStrictEqual(JSON.parse(`{"code":[{"block":[{"attr":{"@_type":"controls_if"},"value":[{"attr":{"@_name":"IF0"},"block":[{"attr":{"@_type":"logic_boolean"},"field":[{"#text":"TRUE","attr":{"@_name":"BOOL"}}]
